...
THERMALD_SYMLINK := $(TARGET_OUT_ETC)/thermald.conf
$(THERMALD_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "thermald.conf link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /system/etc/$(notdir $(subst thermald,thermald-8960,$@)) $@

ALL_DEFAULT_INSTALLED_MODULES += $(THERMALD_SYMLINK)
